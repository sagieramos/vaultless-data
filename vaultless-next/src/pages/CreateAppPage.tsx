...
export default function CreateAppPage() {
  ...
  const handleCopy = (text: string, type: 'secret' | 'publishable') => {
    ...
    toast.success(`${type === 'secret' ? 'Secret' : 'Publishable'} key copied to clipboard!`);
            ...
            <Card className="p-8">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Your application "{formData.name}" is ready to use
                </p>
              </div>
              ...
              <div className="flex items-start gap-3 mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setSavedConfirmation(checked as boolean)}
                />
                <Label htmlFor="saved" className="cursor-pointer text-sm">
                  I've saved my secret key in a secure location and understand I won't be able to see it again
                </Label>
              </div>
              ...
              <p className="text-xs text-center text-gray-600 dark:text-gray-400 mt-4">
                Your keys are stored securely in our system
              </p>
            </Card>
          </motion.div>
        </div>
