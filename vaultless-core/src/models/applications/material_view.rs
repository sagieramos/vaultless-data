...
struct ApplicationWithPricingPlanRow {
    ...
    pub secret_key_is_active: Option<bool>,
    pub secret_key_timestamps: Option<sqlx::types::Json<super::dto::SecretKeyTimestamps>>,
    pub publishable_key_count: i64,
        ...
        E: Executor<'c, Database = Postgres>,
    {
        if !include_pricing_plan {
            ...
            SELECT
                ...
                secret_key_prefix,
                secret_key_scopes,
                secret_key_is_active,
                secret_key_timestamps,
        ...
        SELECT
            ...
            mv.secret_key_scopes,
            mv.secret_key_is_active,
            mv.secret_key_timestamps,
        ...
        let application = ApplicationWithUsage {
            ...
            secret_key_scopes: row.secret_key_scopes,
            secret_key_is_active: row.secret_key_is_active,
            secret_key_timestamps: row.secret_key_timestamps,
        ...
        E: Executor<'c, Database = Postgres>,
    {
        ...
        let sql = format!(
            ...
            SELECT
                ...
                message_quota, secret_key_prefix, secret_key_is_active,
                publishable_key_count,
        ...
        let data = rows
            ...
            .map(|r| ApplicationSummary {
                ...
                tier: r.tier,
                message_quota: r.message_quota,
                secret_key_prefix: r.secret_key_prefix,
                secret_key_is_active: r.secret_key_is_active,
