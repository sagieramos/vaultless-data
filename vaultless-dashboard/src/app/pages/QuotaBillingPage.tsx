...
import {
  CreditCard, Download, Zap, Check, AlertTriangle,
  MessageSquare, HardDrive, Activity, DollarSign, Calendar, ArrowRight
} from 'lucide-react';
      ...
      <Tabs defaultValue="overview" className="space-y-6" onValueChange={setActiveTab}>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid gap-6">
            {applicationBilling.map((app, index) => (
              <motion.div
                key={app.id}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                    ...
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                        ...
                        <Zap className={`w-6 h-6 ${
                          app.plan === 'Free' ? 'text-gray-400' : 'text-white'
                        }`} />
                      </div>
                      <div>
                        <div className="flex items-center gap-3">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {app.plan === 'Enterprise' ? 'Unlimited' : app.plan === 'Pro' ? '100K' : '10K'} messages • Renews Jan 1
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-medium text-gray-900 dark:text-white">
                          {formatNumber(app.usage.messages)} / {app.limits.messages >= 999999999 ? '∞' : formatNumber(app.limits.messages)}
                        </span>
                      </div>
        ...
        <TabsContent value="billing">
          <Card className="overflow-hidden">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                All invoices across your applications
              </p>
            </div>
          ...
          <Card className="p-6 mt-6">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Production API</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">$29.00</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Smart Home Hub</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">$99.00</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Mobile App Backend</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">$29.00</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">$157.00</p>
              </div>
            </div>
          </Card>
        </TabsContent>
